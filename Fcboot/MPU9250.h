...
typedef struct {
	...
	float q[4]; // sensor frame
	float roll, pitch, yaw;

	uint8_t MPU9250_buffer[14];
	uint8_t AK8963_buffer[7];

	uint32_t MPU9250_lastUpdate, AK8963_lastUpdate, hz_lastUpdate;

	uint16_t MPU9250_hz, AK8963_hz;
	uint16_t MPU9250_hzCnt, AK8963_hzCnt;
...
/*
 *  calculate madgwick algorithm
 *  input param : ax, ay, az, gx, gy, gz, mx, my, mz
 *  update quaternion of mpu9250 from NED axis
 */
void MPU9250_madgwickAHRSupdateIMU();	// not use magnetometer
